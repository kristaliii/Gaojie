 ...
 * 店间调拨单体扫描界面
 */
public class tiaoboScanFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.fragment_tiaobo_scan, null);
        initView(view);
        return view;
    }
...
//        getActivity().setTitle("采购扫描");
        ((MainActivity)getActivity()).setTitle("店间调拨扫描");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnQuery: // 查询
                mFHelper.transcateFoward(FragmentFactory.tiaoboQuery_Fragment);
                break;
        }
    }
