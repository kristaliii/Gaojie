...
public class tuihuoScanFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.fragment_tuihuo_scan, null);
        initView(view);
        return view;
    }
...
//        getActivity().setTitle("采购扫描");
        ((MainActivity)getActivity()).setTitle("退货扫描");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnQuery: // 查询
                mFHelper.transcateFoward(FragmentFactory.tuihuoQuery_Fragment);
                break;
        }
    }
