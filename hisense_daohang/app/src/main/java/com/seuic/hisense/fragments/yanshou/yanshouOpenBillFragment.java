 ...
 * 验收开单
 */
public class yanshouOpenBillFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.fragment_yanshou_openbill, null);
        initView(view);
    ...
    public void onResume() {
        super.onResume();
        ((MainActivity)getActivity()).setTitle("验收开单");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnOK:
                mFHelper.transcateFoward(FragmentFactory.yanshouScan_Fragment);// 验收扫描
                break;
            case R.id.btnCancel:
                finish();
                break;
