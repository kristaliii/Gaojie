 ...
 * 要货扫描---门店扫描
 */
public class yaohuoScanFragment extends BaseFragment {

    Button btnQuery; // 查询

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.fragment_yaohuo_scan, null);
        initView(view);
        return view;
    }
...
//        getActivity().setTitle("采购扫描");
        ((MainActivity)getActivity()).setTitle("门店扫描");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnQuery: // 查询
                mFHelper.transcateFoward(FragmentFactory.yaohuoQuery_Fragment);
                break;
        }
    }
}
