 ...
 * 配送开单
 */
public class peisongOpenBillFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.fragment_peisong_openbill, null);
        initView(view);
    ...
    public void onResume() {
        super.onResume();
        ((MainActivity)getActivity()).setTitle("配送开单");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnOK:
                mFHelper.transcateFoward(FragmentFactory.peisongScan_Fragment);// 配送扫描
                break;
            case R.id.btnCancel:
                finish();
                break;
