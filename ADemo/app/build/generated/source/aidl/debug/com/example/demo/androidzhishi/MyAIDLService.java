 ...
 * Original file: F:\\AndroidStudioProjects\\ADemo\\app\\src\\main\\aidl\\com\\example\\demo\\androidzhishi\\MyAIDLService.aidl
 */
package com.example.demo.androidzhishi;
public interface MyAIDLService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.demo.androidzhishi.MyAIDLService
{
private static final java.lang.String DESCRIPTOR = "com.example.demo.androidzhishi.MyAIDLService";
...
/**
 * Cast an IBinder object into an com.example.demo.androidzhishi.MyAIDLService interface,
 * generating a proxy if needed.
 */
public static com.example.demo.androidzhishi.MyAIDLService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.demo.androidzhishi.MyAIDLService))) {
return ((com.example.demo.androidzhishi.MyAIDLService)iin);
}
return new com.example.demo.androidzhishi.MyAIDLService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.demo.androidzhishi.MyAIDLService
{
